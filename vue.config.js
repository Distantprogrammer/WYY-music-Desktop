...
//   const targetUrl = process.env.VUE_APP_BASE_APIL || 'https://netease-cloud-music-api-silk-three-87.vercel.app'
...
module.exports = defineConfig({
  ...
  // devServer: {
  //   proxy: 'https://netease-cloud-music-api-silk-three-87.vercel.app/'
  //   proxy: {
  //     'http://localhost:8080/': {
  //       target: 'https://netease-cloud-music-api-silk-three-87.vercel.app/',
  //       changeOrigin: true
  //       // pathRewrite: {
  //       //   '^/api': '' // rewrite path
  //       // }
